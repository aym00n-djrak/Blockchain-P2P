...
def explore_blockchain_menu_node(node: LoggedInNodeUser):
    ...
    choice = inquirer.select(
        ...
        choices=[
            ...
            # Choice(value="3", name="🚩 Flag a block"),
            Choice(value="4", name="🔙 Back"),
        ],
        default=None,
    ).execute()
    ...
    if choice == "1":
        ...
        block_index = input("Enter block index: ")
        node.flag_block(block_index)
        input("Press a key to continue...")
    elif choice == "4":
        return
